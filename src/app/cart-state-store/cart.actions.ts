...
export const specifcProduct=createAction('Specific Product', props<Product>())
export const filteredProducts=createAction('Filtered Products',props<{products:Product[]}>())
